        ...
        table = $("#tabel-mahasiswa").DataTable({
            ...
            "columnDefs": [{
                ...
                "render": function(data, type, row) {
                    return "<a class=\"btn btn-xs btn-outline-primary edit\" href=\"javascript:void(0)\" title=\"Edit\" data-id=\"" + row[6] + "\"><i class=\"fas fa-edit\"></i> Ubah</a></div> <div class=\"d-inline mx-1\"><a class=\"btn btn-xs btn-outline-danger delete\" href=\"javascript:void(0)\" title=\"Delete\" data-id=\"" + row[6] + "\"><i class=\"fas fa-trash\"></i> Hapus</a></div>";
                },
